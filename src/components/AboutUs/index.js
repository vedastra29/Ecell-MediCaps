    ...
    <div className="about">
      ...
      <div className="ourmission">
        ...
        <div className="cardcomponent">
          <Card
            image={IdeateImg}
            title={jsonData.Ideate.title}
            detail={jsonData.Ideate.detail}
          />
          <Card
            image={InitiateImg}
            title={jsonData.Initiate.title}
            detail={jsonData.Initiate.detail}
          />
          <Card
            image={InnovateImg}
            title={jsonData.Innovate.title}
            detail={jsonData.Innovate.detail}
          />
        </div>
      </div>
    </div>
